...
public class ToolBar extends JPanel {
	...
	public ToolBar(Graph graph) {
		...
		JToggleButton editor = new JToggleButton(new ImageIcon
				(new ImageIcon("src/pictures/mousepointer.png").getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
